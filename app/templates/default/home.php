...
<!-- Navigation -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="/villes">Villes</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="/events">Évènements</a>
                    </li>
                    <li>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Trouvez votre putain de partenaire</div>
                <div class="intro-heading">Faites du sport</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Nos Sports</h2>
    ...
    <section id="services">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">On sport</h2>
                    <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3>
                </div>
            </div>
